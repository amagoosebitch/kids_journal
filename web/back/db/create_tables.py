    ...
    def callee(session):
        ...
        session.create_table(
            ...
            .with_columns(
                ...
                ydb.Column("start_education_time", ydb.PrimitiveType.Timestamp),
                ydb.Column("end_education_time", ydb.PrimitiveType.Timestamp),
        ...
        session.create_table(
            ...
            .with_columns(
                ...
                ydb.Column("success_level_id", ydb.PrimitiveType.Uint64),
            )
        ...
        session.create_table(
            ...
            .with_columns(
                ...
                ydb.Column("first_name", ydb.PrimitiveType.Utf8),
                ydb.Column("last_name", ydb.OptionalType(ydb.PrimitiveType.Utf8)),
                ydb.Column("email", ydb.PrimitiveType.Utf8),  # почему епт фамилия не обязательна, а имейл обязателен?
